...
suite('Unit Tests', function(){
  ...
  // Perubahan: Menambahkan suite untuk getUnit
  suite('Function convertHandler.getUnit(input)', function() {
     ...
     // Perubahan: Menambahkan suite untuk getReturnUnit
   suite('Function convertHandler.getReturnUnit(initUnit)', function() {
    ...
    // Perubahan: Menambahkan suite untuk spellOutUnit
   ...
   // Perubahan: Menambahkan suite untuk convert
